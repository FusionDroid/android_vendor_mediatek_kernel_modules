...
static struct subdrv_static_ctx static_ctx = {
	.sensor_id = MOT_CYBERT_IMX896_SENSOR_ID,
...
const struct subdrv_entry mot_cybert_imx896_mipi_raw_entry = {
	.name = "mot_cybert_imx896_mipi_raw",
	.id = MOT_CYBERT_IMX896_SENSOR_ID,
	.pw_seq = pw_seq,
